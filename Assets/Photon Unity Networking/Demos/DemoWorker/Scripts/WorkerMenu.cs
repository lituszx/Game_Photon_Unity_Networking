...
public class WorkerMenu : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        ...
        if (GUILayout.Button("Skin 1", GUILayout.Width(100)))
        {
            PlayerPrefs.SetInt("Skin", 0);
        }
        if (GUILayout.Button("Skin 2", GUILayout.Width(100)))
        {
            PlayerPrefs.SetInt("Skin", 1);
        }
        if (GUILayout.Button("Skin 3", GUILayout.Width(100)))
        {
            PlayerPrefs.SetInt("Skin", 2);
        }
        if (GUILayout.Button("Skin 4", GUILayout.Width(100)))
        {
        ...
        {
            PhotonNetwork.CreateRoom(this.roomName, new RoomOptions() { MaxPlayers = 10, PublishUserId = true }, null);
        }
